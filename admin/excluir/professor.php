<?php
	...
	//verificar se o professor esta ligado a um curso
	...
	//verifica se existe um curso com este professor cadastrado
	if ( !empty( $dados->id ) ) {
		echo "<script>alert('Este professor não pode ser excluído pois existe um curso ligado a ele');history.back();</script>";
		exit;
	}
